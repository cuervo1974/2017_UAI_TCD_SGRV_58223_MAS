...
#Region "Propiedades + Constructor + Setters"
    ...
    Public Sub SetTipo(ByVal pTipo As Char)
        Me._Tipo = pTipo
    End Sub

    Public Sub SetNombreCliente(ByVal pNombreCliente As String)
        Me._NombreCliente = pNombreCliente
    End Sub

    Public Sub SetCUIT(ByVal pCUIT As String)
        Me._CUIT = pCUIT
    End Sub
...
#Region "Builders Internos"
    ...
    Private Sub ComponerCabecera()
        ...
        With DetallesCabeceraParagraph
            ...
            .AddLineBreak()
            .AddText(String.Format("Tipo de Factura: {0}", Me._Tipo))
            .AddLineBreak()
            .AddText(String.Format("Cliente / Razón Social: {0}", Me._NombreCliente))
        End With

        If Not Me._CUIT = "" Then
            With DetallesCabeceraParagraph
                .AddLineBreak()
                .AddText(String.Format("CUIT: {0}", Me._CUIT))
            End With
        End If
