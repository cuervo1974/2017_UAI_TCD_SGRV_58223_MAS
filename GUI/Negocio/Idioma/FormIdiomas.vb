Public Class FormIdiomas
    ...
    Private Sub RellenarDataGrid(pListado As List(Of Estructura.Idioma))
    ...
    Private Sub Agregar()
        Me._Obj = New Estructura.Idioma
        Me._Obj.PalabrasTraducidas = New List(Of Estructura.PalabraTraducida)
        Me.AbrirDialogo()
    End Sub
